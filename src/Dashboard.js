  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#e0f7fa] to-[#b2ebf2]">
      ...
      <div className="pt-24">
            ...
            <div className="grid gap-3">
              {pacientes.map((p) => (
                <div key={p._id} className="border rounded p-3">
                  ...
                  ) : (geofenceCounts[p._id] ?? 0) > 0 ? (
                    <>Con geocercas: {geofenceCounts[p._id]}</>
                  ) : (
                    "Sin ubicación"
                  )}
                </div>
                  ...
                  <div className="mt-2 flex gap-2">
                    ...
                    <button
                      onClick={() => { setPacienteSeleccionado(p); setViewOpen(true); }}
        ...
        {/* Modal geocercas: guarda UNA por vez */}
        <GeocerceModal
        open={geofenceOpen}
        ...
        onSaved={async () => {
          try {
            ...
            setPopup({ show: true, success: true, message: "Geocerca guardada" });
            setTimeout(() => setPopup({ show: false, success: false, message: "" }), 1500);
          } catch (e) {
      ...
      />
        ...
        {/* Modal solo lectura: ver geocercas */}
        <ViewGeocercasModal
          open={viewOpen}
          paciente={pacienteSeleccionado}
          onClose={() => { setViewOpen(false); setPacienteSeleccionado(null); }}
        />

...
import { listarPacientes, obtenerPaciente, actualizarConfiguracionPaciente, actualizarPaciente, eliminarPaciente } from '../services/pacientes';
...
const IconBed = () => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 mr-1.5"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M7 9m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M22 17v-3h-20" /><path d="M2 8v9" /><path d="M12 14h10v-2a3 3 0 0 0 -3 -3h-7v5z" /></svg>);
const IconFall = () => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M11 21l1 -5l-1 -4l-3 -4h4l3 -3" /><path d="M6 16l-1 -4l3 -4" /><path d="M6 5m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M13.5 12h2.5l4 2" /></svg>);
...
export default function PacienteDetalle() {
  ...
  useEffect(() => {
    ...
    const fetchPatientInfo = async () => {
      ...
      setError("");
      try {
        const pacEncontrado = await obtenerPaciente(pacienteId);
